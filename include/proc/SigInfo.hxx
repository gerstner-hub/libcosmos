...
public: // types
	...
	/**
	 * This is the same basic structure as ChildState used in the `wait()`
	 * family of system calls. In the SigInfo context some additional
	 * fields about CPU time are filled in, though.
	 **/
	struct ChildData :
			public ChildState {
	public: // functions
